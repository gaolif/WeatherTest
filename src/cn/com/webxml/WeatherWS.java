 ...
 * 2018-03-08T16:55:13.121+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "file:/F:/尚硅谷-Linux/其他/weather.wsdl",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/尚硅谷-Linux/其他/weather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/尚硅谷-Linux/其他/weather.wsdl");
        }
        WSDL_LOCATION = url;
    }
